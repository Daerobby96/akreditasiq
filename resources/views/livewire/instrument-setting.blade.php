                    ...
                    <div class="p-6 md:p-8">
                        <div class="flex flex-wrap gap-3">
                            @foreach($table->columns as $column)
                                <div class="px-4 py-3 bg-slate-50 dark:bg-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-800 flex items-center space-x-3 group/col transition-all hover:border-indigo-200">
                                    <div class="flex flex-col">
                                        <span class="text-xs font-bold text-slate-700 dark:text-slate-200">{{ $column->header_name }}</span>
